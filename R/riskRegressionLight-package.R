### riskRegressionLight-package.R --- 
##----------------------------------------------------------------------
## Author: Brice Ozenne
## Created: maj  6 2019 (14:57) 
## Version: 
## Last-Updated: maj  6 2019 (15:02) 
##           By: Brice Ozenne
##     Update #: 4
##----------------------------------------------------------------------
## 
...
#' @docType package
#' @name riskRegressionLight
#' @useDynLib riskRegressionLight, .registration=TRUE
...
######################################################################
### riskRegressionLight-package.R ends here
